        ...
        <Container component="section" sx={{ mt: 10, display: 'flex', justifyContent: "flex-start" }}>
            ...
            <Grid container>
                    ...
                    >
                        <Box component="main" onSubmit={handleSubmit} sx={{ minHeight: 500, maxWidth: 600 }}>
                            ...
                            <Typography variant="h7" >
                                اضغط على الروابط في الأسفل للعرض
                            </Typography>
                            <Grid item  sx={{ mt: 30 }} spacing={5}>
                                {list.map((i) => (
                                    <a href=''>
                                        <Card key={i}
                ...
                >
                    ...
                    <Box
                        component="img"
                        src="https://images.unsplash.com/photo-1588196749597-9ff075ee6b5b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80"
                        alt="call to action"
                        sx={{
                            position: 'absolute',
                            top: -28,
